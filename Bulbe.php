...
<body>
    ...
    <header>
        ...
        <div class="container">
            <a class="navbar-brand" href="accueille.php">Accueil</a>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="navbar-nav">
                        <a class="nav-link" href="Bulbe.php">Bulbes</a>
                    </li>
                        <a class="nav-link" href="Massif.php" id="servicesDropdown" role="button">Plantes à massif</a>
                    <li class="nav-item">
                        <a class="nav-link" href="Rosier.php">Rosiers</a>
                    </li>
                </ul>
            </div>
        </div>
